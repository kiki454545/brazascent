      ...
      <section className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="text-muted-foreground mb-8 leading-relaxed space-y-2">
            ...
            <p><strong>Email :</strong> <a href="mailto:brazascent@gmail.com" className="text-primary hover:underline">brazascent@gmail.com</a></p>
            <p><strong>Site web :</strong> <a href="https://brazascent.com" className="text-primary hover:underline">brazascent.com</a></p>
          </div>
          ...
          <p className="text-muted-foreground mb-8 leading-relaxed">
            Pour plus d'informations sur la collecte et le traitement de vos données, consultez notre <a href="/confidentialite" className="text-primary hover:underline">Politique de confidentialité</a>.
          </p>
          ...
          <div className="mt-12 p-6 bg-cream rounded-lg">
            <p className="text-sm text-muted-foreground">
              Pour toute question concernant ces mentions légales, vous pouvez nous contacter à l'adresse : <a href="mailto:brazascent@gmail.com" className="text-primary hover:underline">brazascent@gmail.com</a>
            </p>
          </div>
        </div>
      </section>
