...
interface UnisexeClientProps {
  initialProducts: Product[]
}

export default function UnisexePage({ initialProducts }: UnisexeClientProps) {
  ...
  return (
    <div className="min-h-screen pt-28">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <Image
          src="https://images.unsplash.com/photo-1594938298603-c8148c4b4d4a?w=1920"
          alt="Parfums Unisexe"
          fill
          sizes="100vw"
        ...
        <div className="absolute inset-0 flex items-center justify-center text-white text-center">
          ...
          >
            ...
            <p className="text-lg font-light max-w-xl mx-auto">
              Des fragrances qui transcendent les genres, pour tous
            </p>
          </m.div>
        </div>
      </section>
