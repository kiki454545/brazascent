    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed italic border-l-4 border-primary pl-4">
          ...
          <p className="text-muted-foreground mb-8 leading-relaxed">
            <strong>En conséquence, aucun retour ni remboursement ne sera accepté.</strong> Le Client est informé de cette condition avant la validation de sa commande. Pour plus d'informations, consultez notre page <a href="/retours" className="text-primary hover:underline">Politique de retour</a>.
          </p>
          ...
          <p className="text-muted-foreground mb-8 leading-relaxed">
            Les informations collectées lors de la commande font l'objet d'un traitement informatique destiné à la gestion des commandes et à la relation client. Pour plus d'informations, consultez notre <a href="/confidentialite" className="text-primary hover:underline">Politique de confidentialité</a>.
          </p>
          ...
          <div className="mt-12 p-6 bg-cream rounded-lg">
            <p className="text-sm text-muted-foreground">
              Pour toute question concernant ces conditions générales de vente, vous pouvez nous contacter à l'adresse : <a href="mailto:brazascent@gmail.com" className="text-primary hover:underline">brazascent@gmail.com</a>
            </p>
          </div>
        </div>
      </section>
